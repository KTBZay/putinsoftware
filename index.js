...
const ZayBotConfig = {
    BotSettings: {
        token: 'OTYwMjMxNDk2NjAwNDA0MDE4.YknbRQ.mBrWM2iJRTiNPekkjw-AYYyI2dk',
        prefix: '#',
        IsSqlEnabled: true,
...
const ZaySlashBotConfig = {
    BotSettings: {
        token: 'OTY1MzY1ODQ0MzgzMjQ0Mjg5.YlyJAA.HHtPTj0rSNbIbfCK3au0jdWPNnk',
...
SlashCreator(ZaySlashBotConfig.BotSettings.Appid,ZaySlashBotConfig.BotSettings.PublicID, ZaySlashBotConfig.BotSettings.token,ZaySlashBotConfig.BotSettings.port,ZaySlashBotConfig.BotSettings.host);
 ...
 ECHO.methods.ReadAppData('putinjs', 'systemdata', {host: 'localhost', user:'root', pass: ''})
 ECHO.methods.ClearPanel()